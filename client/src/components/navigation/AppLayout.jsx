...
// const WARNING_TIMEOUT = INACTIVITY_TIMEOUT - 60000; // 1 minute warning
...
//         text: "You have been inactive for 30 minutes. You will be logged out for security reasons.",
//         icon: "warning",
//         timer: 5000,
...
//           result.isDismissed
//         ) {
//           // Timer expired or user dismissed
//           handleAutoLogout();
//         }
//       });
//     }, WARNING_TIMEOUT);
...
//       }
//     };
//   }, [handleUserActivity]); // Only depend on handleUserActivity
...
const AppLayout = () => {
  ...
  // Debug: Log timer states (remove in production)
  useEffect(() => {
    const interval = setInterval(() => {
      console.log("Timers active:", {
        logoutTimer: !!logoutTimerRef.current,
        warningTimer: !!warningTimerRef.current,
        warningShown: isWarningShownRef.current,
      });
    }, 60000);
